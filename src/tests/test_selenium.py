...
class TestLoginPage(Basic_Chrome_Test):
    ...
    def test_user_exist(self):
        ...
        errors = self.driver.find_elements_by_class_name("errors")
        assert (
            errors[0].text == "This Username is already in use. Please try another one."
        )
    ...
    def test_bad_login(self):
        ...
        assert (
            self.driver.find_element_by_id("errors").text
            == "Incorrect Username/Email and/or Password"
        )
